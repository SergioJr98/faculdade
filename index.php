    ...
    <main>
        ...
        <div id="carouselExampleIndicators" class="carousel slide">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="img/banner 1.gif" class="d-block w-100" alt="Promoção de jogos" />
                </div>
                <div class="carousel-item">
                    <img src="img/banner 2.jpg" class="d-block w-100" alt="Banner livros aproveite" />
                </div>
                <div class="carousel-item">
                    <img src="img/banner 3.jpg" class="d-block w-100" alt="frete gratis em compras acima de R$200,00" />
                </div>
            </div>
            <!--Fim slide carrousel-->
        ...
        <div class="slider-livros clearfix" style="float: left;">
            <div class="item-livro">
                <a href="#"><img src="imagens/Livros/produto_livro_1.jpg" alt="#"></a>
            </div>
            <div class="item-livro">
                <a href="#"><img src="imagens/Livros/produto_livro_2.jpg" alt="#"></a>
            </div>
            <div class="item-livro">
                <a href="#"><img src="imagens/Livros/produto_livro_3.jpg" alt="#"></a>
            </div>
            <div class="item-livro">
                <a href="#"><img src="imagens/Livros/produto_livro_4.jpg" alt="#"></a>
            </div>
            <div class="item-livro">
                <a href="#"><img src="imagens/Livros/produto_livro_5.jpg" alt="#"></a>
            </div>
            <div class="item-livro">
                <a href="#"><img src="imagens/Livros/produto_livro_6.jpg" alt="#"></a>
            </div>
        ...
        <!-- <div class="slider clearfix">
            ...
            <div class="item">
                <a href="produtos.php?"><img src="img/avatar-1.jpg" alt="#"></a>
            </div>
            <div class="item">
